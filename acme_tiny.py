...
def get_crt(account_key, csr, acme_dir, acme_host=None, log=LOGGER, CA=DEFAULT_CA, disable_check=False, directory_url=DEFAULT_DIRECTORY_URL, contact=None):
...
def main(argv=None):
    ...
    signed_crt = get_crt(args.account_key, args.csr, args.acme_dir, acme_host=args.acme_host, log=LOGGER, CA=args.ca, disable_check=args.disable_check, directory_url=args.directory_url, contact=args.contact)
